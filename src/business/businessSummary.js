                            ...
                            </div>
                            {
                                (window.innerWidth>800) ? <div style={{ float: 'left', margin: '2em 3em 3em 2em' , width:250}}>
                                        ...
                                        <List>
                                            <List.Item >
                                                <List.Icon name='leaf' />
                                                <List.Content><Header color='green' as='h3'>{(this.state.blogs[0].title.length>21) ? blogs[Object.keys(blogs)[0]].title.slice(0,22)+'.....' : blogs[Object.keys(blogs)[0]].title}</Header></List.Content>

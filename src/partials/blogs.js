                        ...
                        <div>
                            { _.times(this.props.blogs.length, i =>
                                    <List.Item key={this.props.blogs[i].postID} >
                                        ...
                                        <button className="redMoreButton" ref={this.props.blogs[i].postID} onClick={() => { this.props.onReadMore(this.props.blogs[i]) }} name="all" style={{color:'blue',backgroundColor:'transparent',border:'none'}}><span>Read</span></button>
                                        <hr/>
                                    </List.Item>
                                )
                            }

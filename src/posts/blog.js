...
export default class WelcomePage extends React.Component {
    ...
    setBlogCounts(){
        ...
        return Promise.all([
            ...
            axios.get('https://public.newsharecounts.com/count.json?url=http://zemuldo.com/'+this.props.blogDetails.title.split(' ').join('-')+'_'+this.props.blogDetails.date.split(' ').join('-')+'_'+this.props.blogDetails.id.toString(),{}),

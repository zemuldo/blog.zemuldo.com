...
class HomePage extends Component {
    ...
    tick () {
        return Promise.all([axios.get('http://zemuldo.com:8090/posts/tech', {}),axios.get('http://zemuldo.com:8090/posts/business/How to keep your Customers', {})])
            .then(response => {
    ...
    handleFilterChange(e) {
        //e.preventDefault();
        if(e.target.value===''){
            return axios.get('http://zemuldo.com:8090/post/tech', {})
                .then(response => {
